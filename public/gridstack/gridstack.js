...
(function (factory) {
    ...
    GridStack.prototype._prepare_element = function (el) {
        ...
        var on_start_moving = function (event, ui) {
            ...
            self.container.trigger('onStartMove', [node]);
        };
        ...
        var on_end_moving = function (event, ui) {
            ...
            self.container.trigger('onFinishDrop', [node]);
        };
        ...
        el.draggable(_.extend(this.opts.draggable, {
            ...
            drag: function (event, ui) {
                ...
                self.container.trigger('onMove', [node]);
            },
            revert: function(valid){
                if(self.opts.allowed_grids && self.opts.allowed_grids.indexOf(node.x) < 0) {
                    node.reverted = true;
                    return "invalid";
                }
                else return valid;
